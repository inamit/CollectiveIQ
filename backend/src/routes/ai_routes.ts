 ...
 *         model:
 *           type: string
 *           description: The AI model to use (e.g. gemini, meta, llama, versatile)
 *         parentCommentID:
 *           type: string
 ...
 *       description: Fetches a response from the specified AI model (Gemini, Meta, Llama, Versatile, etc.)
